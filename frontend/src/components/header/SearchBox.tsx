  ...
  return (
    <Animate isMounted={active} unmountDelay={600}>
      <div className="search">
        <div onClick={() => setDialog(null)} className="search__backdrop"></div>
        <div className="search__box">
          ...
          <div className="search__container">
            ...
            <div className="search__trends">
              ...
              <button
                onClick={() => searchChangedHandler("hoodie")}
                className="search__trends-tag"
              >
                hoodie
              </button>
              <button
                onClick={() => searchChangedHandler("shirt")}
                className="search__trends-tag"
              >
                shirt
              </button>
              <button
                onClick={() => searchChangedHandler("decor")}
                className="search__trends-tag"
              >
                decor
              </button>
